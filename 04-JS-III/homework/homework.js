...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  let concatenando = palabras.join(" ");
  return concatenando;
}
...
function empiezaConNueve(n) {
  ...
  //Debe retornar true si el entero si inicia con 9 y false en otro caso.
  //Escribe tu código aquí:
...
function mayorACien(array) {
  //La función recibe un array con enteros entre 0 y 200. Recorrer el
  //array y guardar en un nuevo array sólo los
  //valores mayores a 100 (no incluye el 100). Finalmente devolver el
  //nuevo array.
  // Tu código:
...
function continueStatement(numero) {
  ...
  //Guardar cada nuevo valor en un array.    
  //Devolver el array
  //Cuando el número de iteraciones alcance el valor 5, no se suma en
  //ese caso y se continua con la siguiente iteración
