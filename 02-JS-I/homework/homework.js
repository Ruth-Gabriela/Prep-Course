...
function retornarPerimetro(lado){
  //Escribe una función a la cual reciba el valor del lado de
  //un cuadrado y retorne su perímetro.
...
function esVocal(letra){
  ...
  //mensaje “Es vocal”. 
  //Verificar si el usuario ingresó un string de más de un carácter, en ese
  //caso, informarle 
